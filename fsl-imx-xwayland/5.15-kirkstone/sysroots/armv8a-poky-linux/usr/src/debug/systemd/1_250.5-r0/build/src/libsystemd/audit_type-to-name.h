const char *audit_type_to_string(int type) {
	switch(type) {
        ...
        case AUDIT_TIME_INJOFFSET: return "TIME_INJOFFSET";
        case AUDIT_TIME_ADJNTPVAL: return "TIME_ADJNTPVAL";
        case AUDIT_BPF: return "BPF";
        case AUDIT_EVENT_LISTENER: return "EVENT_LISTENER";
        case AUDIT_URINGOP: return "URINGOP";
        case AUDIT_OPENAT2: return "OPENAT2";
        case AUDIT_DM_CTRL: return "DM_CTRL";
        case AUDIT_DM_EVENT: return "DM_EVENT";
        ...
        case AUDIT_ANOM_CREAT: return "ANOM_CREAT";
        ...
        case AUDIT_INTEGRITY_EVM_XATTR: return "INTEGRITY_EVM_XATTR";
        case AUDIT_INTEGRITY_POLICY_RULE: return "INTEGRITY_POLICY_RULE";
