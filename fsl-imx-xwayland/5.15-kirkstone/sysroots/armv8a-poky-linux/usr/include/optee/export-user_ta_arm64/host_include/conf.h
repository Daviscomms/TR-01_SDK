#ifndef __home_kcchea_Desktop_daviscomms_bsp_temp_build_tmp_work_imx8mp_lpddr4_evk_poky_linux_optee_os_3_17_0_imx_r0_build_include_generated_conf_h_
#define __home_kcchea_Desktop_daviscomms_bsp_temp_build_tmp_work_imx8mp_lpddr4_evk_poky_linux_optee_os_3_17_0_imx_r0_build_include_generated_conf_h_
...
#define CFG_CAAM_ITR 1
#define CFG_CAAM_JR_DISABLE_NODE 1
#define CFG_CAAM_SGT_ALIGN 1
#define CFG_CAAM_SIZE_ALIGN 1
...
#define CFG_DBG_CAAM_BUF 0x0
#define CFG_DBG_CAAM_DESC 0x0
#define CFG_DBG_CAAM_TRACE 0x2
...
#define CFG_IMX_DEK_HAB 1
#define CFG_IMX_DIGPROG 1
#define CFG_IMX_OCOTP 1
#define CFG_IMX_SNVS 1
#define CFG_IMX_UART 1
#define CFG_JR_BLOCK_SIZE 0x1000
#define CFG_JR_HAB_INDEX 0
#define CFG_JR_INDEX 2
#define CFG_JR_INT 146
...
#define CFG_NXP_CAAM 1
#define CFG_NXP_CAAM_ACIPHER_DRV 1
#define CFG_NXP_CAAM_BLOB_DRV 1
#define CFG_NXP_CAAM_CIPHER_DRV 1
#define CFG_NXP_CAAM_CMAC_DRV 1
#define CFG_NXP_CAAM_DH_DRV 1
#define CFG_NXP_CAAM_DSA_DRV 1
#define CFG_NXP_CAAM_ECC_DRV 1
#define CFG_NXP_CAAM_HASH_DRV 1
#define CFG_NXP_CAAM_HMAC_DRV 1
#define CFG_NXP_CAAM_MP_DRV 1
#define CFG_NXP_CAAM_RNG_DRV 1
#define CFG_NXP_CAAM_RSA_DRV 1
#define CFG_NXP_CAAM_RSA_KEY_FORMAT 3
#define CFG_NXP_CAAM_RUNTIME_JR 1
#define CFG_NXP_CAAM_SGT_V1 1
#define CFG_NXP_CAAM_SM_DRV 1
...
#define CFG_SHMEM_START ((0x40000000 + 0x16000000) + 0x01e00000)
...
#define CFG_TZDRAM_START (0x40000000 + 0x16000000)
